...
def solve_default(lamb=None, mode=0, print_N=print_N, max_iter=default_iter):
...
def solve_default_alt(lamb=None, mode=0, print_N=print_N, max_iter=default_iter):
    """Solves for Beta (TE Mode) under default start and end conditions
...
def solve_range(start, end, lamb=None, mode=0, print_N=print_N, max_iter=default_iter):
...
def solve_mag(lamb=None, mode=0, print_N=print_N, max_iter=default_iter):
...
def solve_2d_default(lamb=None, mode=0, mode_2=0, ret_trans=False, max_iter=default_iter, print_statements=False):
...
def ey_default(lamb=None, mode=0, margin=1.5, max_solver_iter=default_iter, divisions=plot_divisions, correct_2d=False):
...
def ey_default_alt(lamb=None, mode=0, margin=1.5, max_solver_iter=default_iter, divisions=plot_divisions, correct_2d=False):
...
def plot_ey_default(lamb=None, mode=0, margin=1.5, peak_normalize=False, true_normalize=False, center=False, max_solver_iter=default_iter, divisions=plot_divisions, target_file=None, no_output=False):
...
def ey_2d_eff(lamb=None, mode=0, mode_2=0, margin_x=10, margin_y=10, max_solver_iter=default_iter, divisions=plot_divisions):
...
def ey_2d_eff_alt(lamb=None, mode=0, mode_2=0, margin_x=10, margin_y=10, max_solver_iter=default_iter, divisions=plot_divisions):
    """Evaluates the ey values along both the x and y axes and plots them
...
def ey_2d_marcatili(lamb=None, mode=0, mode_2=0, margin_x=10, margin_y=10, max_solver_iter=default_iter, divisions=plot_divisions, ignore_beta=False):
    """Evaluates the ey values along both the x and y axes and plots them
...
def plot_2d(ey=ey_2d_marcatili, lamb=None, mode=0, mode_2=0, margin_x=2, margin_y=2, max_solver_iter=default_iter, divisions=plot_divisions, normalize=False, target_file=None):
...
def em_default(lamb=None, mode=0, margin=1.5, max_solver_iter=default_iter, divisions=divisions):
...
def absorption_loss(N=1e18, lamb=None, doping="n", print_afc=False, constant=False):
...
def absorption_default(N=1e18, lamb=None, doping="n", print_afc=False):
...
def roughness_loss(lamb=None, mode=0, roughness=11.5e-9, print_statements=False):
...
def roughness_loss_2d(lamb=None, mode=0, mode_2=0, roughness=11e-9, correct_theta=False, print_statements=False, method=1, fixed_thickness=False):
...
def roughness_loss_solver(lamb=None, mode=0, roughness=11e-9, solver=solve_default, print_statements=False):
...
def roughness_loss_theta(theta_incident=23, lamb=None, mode=0, roughness=11e-9, solver=solve_default, print_statements=False):
...
def propagation_angle_2d(lamb=None, mode=0, ret_beta=False):
...
def effective_film_thickness_default(mode=0, lamb=None, solver=solve_default):
...
def effective_film_thickness_x(kx, lamb=None):
...
def effective_film_thickness_y(ky, lamb=None):
...
def effective_film_thickness_2d(lamb=None, mode=0, mode_2=0, fixed_thickness=False):
...
def confinement_factor_single_mode(lamb=None, solver=solve_default):
...
def confinement_factor(lamb=None, mode=0, margin=20, print_statements=False):
...
def confinement_factor_alt(lamb=None, mode=0, margin=20, print_statements=False):
    """Computes the confinement factor looking at a single mode
...
def confinement_factor_interface_2d(roughness=11.5e-9, lamb=None, mode=0, mode_2=0, margin=20, divisions=plot_divisions, include_corners=True, correct_2d=True):
...
def total_confinement_factor(lamb=None, margin=50):
